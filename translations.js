...
var LanguageContext = (function () {
    ...
    var translations = {
        ...
        'faq.a3':                { da: 'Ja, i høj grad. Kasper er faglært tømrer med en baggrund i entrepriseprojekter. Både som selvstændig og som byggeleder.<br><br>Kasper har erfaring med alt fra tunge konstruktioner til fint snedkerarbejde, herunder:<ul class="list-disc pl-5 mt-2 space-y-1"><li><strong>Totalrenovering:</strong> F.eks. lejlighedssammenlægninger og ombygninger.</li><li><strong>Specialinventar:</strong> Radiatorskjulere og indbyggede løsninger.</li><li><strong>Klassisk håndværk:</strong> Frederiksberg-paneler og stuk-detaljer.</li></ul><br><em>\'Du får ikke bare en tagdækker. Du får en fagmand, der er vant til at arbejde med millimeterpræcision – uanset om det er tagkonstruktionen eller finishen på sternbrædderne.\'</em>', en: 'Yes, absolutely. Kasper is a skilled carpenter with a background in large-scale construction projects, both as self-employed and as a construction manager.<br><br>Kasper has experience with everything from heavy structural work to fine joinery, including:<ul class="list-disc pl-5 mt-2 space-y-1"><li><strong>Total renovation:</strong> E.g., merging apartments and remodeling.</li><li><strong>Custom fittings:</strong> Radiator covers and built-in solutions.</li><li><strong>Classic craftsmanship:</strong> Wall paneling and stucco details.</li></ul><br><em>\'You are not just getting a roofer. You get a craftsman used to working with millimeter precision – whether it\'s the roof structure or the finish on the fascia boards.\'</em>', de: 'Ja, absolut. Kasper ist gelernter Zimmermann mit Hintergrund in Bauprojekten, sowohl als Selbstständiger als auch als Bauleiter.<br><br>Kasper hat Erfahrung mit allem, von schweren Konstruktionen bis hin zu feinen Tischlerarbeiten, darunter:<ul class="list-disc pl-5 mt-2 space-y-1"><li><strong>Totalrenovierung:</strong> Z.B. Wohnungszusammenlegungen und Umbauten.</li><li><strong>Spezialeinbauten:</strong> Heizkörperverkleidungen und Einbaulösungen.</li><li><strong>Klassisches Handwerk:</strong> Wandpaneele und Stuckdetails.</li></ul><br><em>\'Sie bekommen nicht nur einen Dachdecker. Sie erhalten einen Fachmann, der Millimeterarbeit gewohnt ist – egal ob bei der Dachkonstruktion oder dem Abschluss der Stirnbretter.\'</em>' },
        ...
        'modal.terms.body':      {
            da: '<p><strong>1. Generelt</strong><br>Disse betingelser gælder for alle køb foretaget hos EPDM Specialisten v/ Kasper Junget Ravn Hansen. Vi leverer primært til private (B2C) og erhverv (B2B) i Danmark.</p><p><strong>2. Bestilling og Betaling</strong><br>Da alle vores produkter er specialfremstillede (Cut-to-size), produceres ordren først, når betaling er modtaget. Betaling foregår via faktura/bankoverførsel. Betalingsfrist er 7 dage netto. Ved manglende betaling annulleres ordren.</p><p><strong>3. Ingen Fortrydelsesret på Målvarer</strong><br>I henhold til Forbrugeraftalelovens § 18, stk. 2, nr. 3 gælder fortrydelsesretten IKKE for varer, der er fremstillet efter forbrugerens specifikationer eller har fået et tydeligt personligt præg. Dette gælder alle EPDM-duge, der skæres på mål. Du kan kun fortryde købet, INDEN produktionen/skæringen er påbegyndt.</p><p><strong>4. Reklamation</strong><br>Du har 2 års reklamationsret i henhold til købeloven. Dette dækker fabrikationsfejl og mangler. Skader opstået som følge af forkert montering, håndtering eller almindeligt slid er ikke dækket. Ved transportskader skal du sende billeddokumentation til os senest 48 timer efter modtagelse.</p><p><strong>5. Garanti</strong><br>Vi viderestiller producentens (DWZ) materialegaranti på op til 50 år, forudsat at materialet er monteret korrekt efter gældende forskrifter. EPDM Specialisten hæfter ikke for følgeskader som følge af forkert installation.</p>',
            en: '<p><strong>1. General</strong><br>These terms apply to all purchases made from EPDM Specialisten by Kasper Junget Ravn Hansen. We primarily deliver to private (B2C) and business (B2B) customers in Denmark.</p><p><strong>2. Orders and Payment</strong><br>As all our products are custom-made (Cut-to-size), production only begins once payment has been received. Payment is made via invoice/bank transfer. Payment deadline is 7 days net. In case of non-payment, the order will be cancelled.</p><p><strong>3. No Right of Withdrawal on Custom Products</strong><br>In accordance with the Danish Consumer Contracts Act § 18, subsection 2, no. 3, the right of withdrawal does NOT apply to goods manufactured to the consumer\'s specifications or that have been given a clearly personal character. This applies to all EPDM membranes cut to size. You can only cancel the purchase BEFORE production/cutting has begun.</p><p><strong>4. Complaints</strong><br>You have a 2-year right of complaint under the Sale of Goods Act. This covers manufacturing defects and faults. Damage caused by incorrect installation, handling, or normal wear and tear is not covered. For transport damage, you must send photo documentation to us within 48 hours of receipt.</p><p><strong>5. Warranty</strong><br>We pass on the manufacturer\'s (DWZ) material warranty of up to 50 years, provided the material has been installed correctly according to applicable regulations. EPDM Specialisten is not liable for consequential damages due to incorrect installation.</p>',
            de: '<p><strong>1. Allgemeines</strong><br>Diese Bedingungen gelten für alle Käufe bei EPDM Specialisten von Kasper Junget Ravn Hansen. Wir liefern hauptsächlich an Privat- (B2C) und Geschäftskunden (B2B) in Dänemark.</p><p><strong>2. Bestellung und Zahlung</strong><br>Da alle unsere Produkte maßgefertigt werden (Cut-to-size), beginnt die Produktion erst nach Zahlungseingang. Die Zahlung erfolgt per Rechnung/Banküberweisung. Zahlungsfrist ist 7 Tage netto. Bei Nichtzahlung wird die Bestellung storniert.</p><p><strong>3. Kein Widerrufsrecht bei Maßanfertigungen</strong><br>Gemäß dem dänischen Verbraucherschutzgesetz § 18, Abs. 2, Nr. 3 gilt das Widerrufsrecht NICHT für Waren, die nach den Spezifikationen des Verbrauchers hergestellt wurden oder ein eindeutig persönliches Gepräge erhalten haben. Dies gilt für alle maßgeschnittenen EPDM-Bahnen. Sie können den Kauf nur stornieren, BEVOR die Produktion/der Zuschnitt begonnen hat.</p><p><strong>4. Reklamation</strong><br>Sie haben ein 2-jähriges Reklamationsrecht gemäß dem Kaufrecht. Dies deckt Herstellungsfehler und Mängel ab. Schäden durch fehlerhafte Montage, Handhabung oder normalen Verschleiß sind nicht abgedeckt. Bei Transportschäden müssen Sie uns innerhalb von 48 Stunden nach Erhalt eine Fotodokumentation zusenden.</p><p><strong>5. Garantie</strong><br>Wir leiten die Materialgarantie des Herstellers (DWZ) von bis zu 50 Jahren weiter, vorausgesetzt das Material wurde korrekt nach den geltenden Vorschriften montiert. EPDM Specialisten haftet nicht für Folgeschäden aufgrund fehlerhafter Installation.</p>'
        },
        ...
        'modal.privacy.body':    {
            da: '<p><strong>1. Dataansvarlig</strong><br>Kasper Junget Ravn Hansen<br>Tagensvej 164, 4. th, 2200 København N<br>Email: info@epdm-specialisten.dk</p><p><strong>2. Hvilke data indsamler vi?</strong><br>Vi indsamler kun de oplysninger, der er strengt nødvendige for at behandle din forespørgsel og ordre: Navn, adresse, telefonnummer og e-mailadresse.</p><p><strong>3. Funktionelle cookies og teknologier</strong><br>Med dit samtykke ("Accepter alle") anvender vi:</p><ul class="list-disc pl-5 space-y-2"><li><strong>Enhedsfingerprint:</strong> En anonymiseret hash af basale enhedsoplysninger (browser, skærmstørrelse, tidszone) bruges til svindelforebyggelse ved prisberegning. Hashen kan ikke spores tilbage til dig personligt.</li><li><strong>localStorage:</strong> Dit samtykkevalg gemmes lokalt i din browser (nøgle: <code>functionalConsent</code>). Der bruges ingen tredjeparts tracking-cookies.</li></ul><p>Vælger du "Kun nødvendige", fungerer prisberegneren uden fingerprint.</p><p><strong>4. Databehandling</strong><br>Alle API-kald behandles via Cloudflare Workers på europæiske edge-servere. Dine kontaktoplysninger videregives kun til vores leverandør (DWZ/fragtmand) med det ene formål at levere varen til dig.</p>',
            en: '<p><strong>1. Data Controller</strong><br>Kasper Junget Ravn Hansen<br>Tagensvej 164, 4. th, 2200 Copenhagen N<br>Email: info@epdm-specialisten.dk</p><p><strong>2. What data do we collect?</strong><br>We only collect the information strictly necessary to process your inquiry and order: Name, address, phone number, and email address.</p><p><strong>3. Functional cookies and technologies</strong><br>With your consent ("Accept all") we use:</p><ul class="list-disc pl-5 space-y-2"><li><strong>Device fingerprint:</strong> An anonymized hash of basic device information (browser, screen size, timezone) is used for fraud prevention during price calculation. The hash cannot be traced back to you personally.</li><li><strong>localStorage:</strong> Your consent choice is stored locally in your browser (key: <code>functionalConsent</code>). No third-party tracking cookies are used.</li></ul><p>If you choose "Necessary only", the price calculator works without fingerprinting.</p><p><strong>4. Data Processing</strong><br>All API calls are processed via Cloudflare Workers on European edge servers. Your contact information is only shared with our supplier (DWZ/carrier) for the sole purpose of delivering the goods to you.</p>',
            de: '<p><strong>1. Verantwortlicher</strong><br>Kasper Junget Ravn Hansen<br>Tagensvej 164, 4. th, 2200 Kopenhagen N<br>E-Mail: info@epdm-specialisten.dk</p><p><strong>2. Welche Daten erheben wir?</strong><br>Wir erheben nur die Informationen, die zur Bearbeitung Ihrer Anfrage und Bestellung unbedingt erforderlich sind: Name, Adresse, Telefonnummer und E-Mail-Adresse.</p><p><strong>3. Funktionale Cookies und Technologien</strong><br>Mit Ihrer Zustimmung ("Alle akzeptieren") verwenden wir:</p><ul class="list-disc pl-5 space-y-2"><li><strong>Geräte-Fingerabdruck:</strong> Ein anonymisierter Hash grundlegender Geräteinformationen (Browser, Bildschirmgröße, Zeitzone) wird zur Betrugsprävention bei der Preisberechnung verwendet. Der Hash kann nicht auf Sie persönlich zurückverfolgt werden.</li><li><strong>localStorage:</strong> Ihre Einwilligungsentscheidung wird lokal in Ihrem Browser gespeichert (Schlüssel: <code>functionalConsent</code>). Es werden keine Tracking-Cookies von Drittanbietern verwendet.</li></ul><p>Wenn Sie "Nur notwendige" wählen, funktioniert der Preisrechner ohne Fingerprinting.</p><p><strong>4. Datenverarbeitung</strong><br>Alle API-Aufrufe werden über Cloudflare Workers auf europäischen Edge-Servern verarbeitet. Ihre Kontaktdaten werden nur an unseren Lieferanten (DWZ/Spediteur) weitergegeben, ausschließlich zum Zweck der Warenlieferung an Sie.</p>'
        },
